...
public class TaskOverlay extends OverlayPanel {
  ...
  @Inject
  private TaskOverlay(final ConstructionPlugin plugin, final ConstructionConfig config) {
    super(plugin);
  ...
  public Dimension render(Graphics2D graphics) {
    ...
    int xpGained = client.getSkillExperience(Skill.CONSTRUCTION) - plugin.getInitialXpAmount();
